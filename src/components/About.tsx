        ...
        <div className="grid-2">
          ...
          <div>
            {['IEEE Education Week Sri Lanka is a unique opportunity for students and undergraduates to connect with top professionals and educators from the world of engineering and technology.',
              `Held at TRACE Expert City on the ${eventDate.getDate()}${getOrdinalSuffix(eventDate.getDate())} of ${eventDate.toLocaleString('default', { month: 'long' })}, the event delivers educational programs for students, educators, and technical professionals.`,
